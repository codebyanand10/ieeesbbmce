...
var require_vanta_birds_min = __commonJS({
  "node_modules/vanta/dist/vanta.birds.min.js"(exports, module) {
    !(function(e, t) {
      ...
      function n(e2) {
        for (; e2.children && e2.children.length > 0; ) n(e2.children[0]), e2.remove(e2.children[0]);
      ...
      const x = function(e2, t2, i2, n2) {
        ...
        s2.add(h2), this.setDataType = function(e3) {
          ...
          if (!i2.capabilities.isWebGL2 && !i2.extensions.get("OES_texture_float")) return "No OES_texture_float support for float textures.";
          if (0 === i2.capabilities.maxVertexTextures) return "No support for vertex shader textures.";
          for (var n3 = 0; n3 < this.variables.length; n3++) {
            ...
            if (null !== o3.dependencies) for (var a3 = 0; a3 < o3.dependencies.length; a3++) {
              var l3 = o3.dependencies[a3];
              if (l3.name !== o3.name) {
                for (var h3 = false, c2 = 0; c2 < this.variables.length; c2++) if (l3.name === this.variables[c2].name) {
                  h3 = true;
                  break;
                }
                if (!h3) return "Variable dependency not found. Variable=" + o3.name + ", dependency=" + l3.name;
              }
          ...
          for (var e3 = this.currentTextureIndex, t3 = 0 === this.currentTextureIndex ? 1 : 0, i3 = 0, n3 = this.variables.length; i3 < n3; i3++) {
            ...
            if (null !== o3.dependencies) for (var s3 = o3.material.uniforms, r3 = 0, a3 = o3.dependencies.length; r3 < a3; r3++) {
      ...
      class R {
        constructor(e2) {
          ...
          this.position = new T.Vector3(), this.velocity = new T.Vector3(), t2 = new T.Vector3(), this.setGoal = function(e3) {
            ...
            for (var r3 = 0, h2 = e3.length; r3 < h2; r3++) Math.random() > 0.6 || (i3 = (t3 = e3[r3]).position.distanceTo(this.position)) > 0 && i3 <= s3 && (n3.add(t3.velocity), o3++);
            if (o3 > 0) {
              n3.divideScalar(o3);
              var c2 = n3.length();
            ...
            for (var h2 = 0, c2 = e3.length; h2 < c2; h2++) Math.random() > 0.6 || (i3 = (t3 = e3[h2]).position.distanceTo(this.position)) > 0 && i3 <= r3 && (n3.add(t3.position), s3++);
            ...
            for (var r3 = 0, a3 = e3.length; r3 < a3; r3++) Math.random() > 0.6 || (i3 = (t3 = e3[r3]).position.distanceTo(this.position)) > 0 && i3 <= s3 && (o3.subVectors(this.position, t3.position), o3.normalize(), o3.divideScalar(i3), n3.add(o3));
            return n3;
          };
        }
      }
      class E extends l {
        ...
        initGpgpuBirds() {
          const e2 = ((e3) => {
            ...
            let l2 = 0;
            const h2 = function() {
              for (let e4 = 0; e4 < arguments.length; e4++) o2.array[l2++] = arguments[e4];
            }, c2 = e3.wingSpan || 20, d2 = e3.birdSize || 1;
            for (let e4 = 0; e4 < S; e4++) h2(0, -0, -20 * d2, 0, 4 * d2, -20 * d2, 0, 0, 30 * d2), h2(0, 0, -15 * d2, -c2 * d2, 0, 0, 0, 0, 15 * d2), h2(0, 0, 15 * d2, c2 * d2, 0, 0, 0, 0, -15 * d2);
            const u2 = {};
            for (l2 = 0; l2 < 3 * i3; l2++) {
        ...
        getNewCol(e2) {
          ...
          } else r2 = 0 == t2.colorMode.indexOf("mix") ? new T.Color(i2 + a2 * n2) : o2.lerp(s2, a2);
          return r2;
        }
        onInit() {
          ...
          if (M) try {
            ...
            for (var s2 = 0; s2 < l2; s2++) {
              ...
              if (h2) for (var r2 = 0; r2 < c2.index.array.length; r2 += 3) for (var a2 = 0; a2 <= 2; a2++) {
                ...
                for (r2 = 0; r2 < u2.array.length; r2 += 3) u2.array[r2] = e3.r, u2.array[r2 + 1] = e3.g, u2.array[r2 + 2] = e3.b;
              }
        ...
        onUpdate() {
          ...
          if (e2 > 1 && (e2 = 1), this.last = this.now, M) this.positionUniforms.time.value = this.now, this.positionUniforms.delta.value = e2, this.velocityUniforms.time.value = this.now, this.velocityUniforms.delta.value = e2, this.birdUniforms.time.value = this.now, this.birdUniforms.delta.value = e2, this.velocityUniforms.predator.value.set(this.mouseX, -this.mouseY, 0), this.mouseX = 1e4, this.mouseY = 1e4, this.gpuCompute.compute(), this.birdUniforms.texturePosition.value = this.gpuCompute.getCurrentRenderTarget(this.positionVariable).texture, this.birdUniforms.textureVelocity.value = this.gpuCompute.getCurrentRenderTarget(this.velocityVariable).texture;
          else {
        ...
        onMouseMove(e2, t2) {
          if (this.mouseX = e2 - 0.5, this.mouseY = t2 - 0.5, !M) {
            const e3 = this.boids;
            let t3;
            for (var i2 = new T.Vector3(this.mouseX * this.width, -this.mouseY * this.height, 0), n2 = 0, o2 = e3.length; n2 < o2; n2++) t3 = e3[n2], i2.z = t3.position.z, t3.repulse(i2);
          }
        }
        onDestroy() {
        }
